...
namespace cb
{
    ...
    class Window
    {
        public:
            ...
            {
                sum_ += value - window_[index]; // difference between new and old
            ...
            {
                return window_[next_index()];
            }
            // The delta over the window.
            double Delta() const
            {
                return window_[index_] - Previous();
            }
...
*/
    ...
    private:
        ...
        Window m_rollDeltaWindow(10);  // Delta  over 10 cycles = 100 msec = 0.1 seconds.
